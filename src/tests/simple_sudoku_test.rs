...
mod tests {
    ...
    fn test_parse_file() {
        ...
        if let Err(((x1, y1), (x2, y2))) = parsed_sudoku.is_valid() {
            ...
            expected_sudoku.set_value(0, 0, 4);
            expected_sudoku.set_value(6, 0, 8);
            expected_sudoku.set_value(8, 0, 5);
            expected_sudoku.set_value(1, 1, 3);
            expected_sudoku.set_value(3, 2, 7);
            expected_sudoku.set_value(1, 3, 2);
            expected_sudoku.set_value(7, 3, 6);
            expected_sudoku.set_value(4, 4, 8);
            expected_sudoku.set_value(6, 4, 4);
            expected_sudoku.set_value(4, 5, 1);
            expected_sudoku.set_value(3, 6, 6);
            expected_sudoku.set_value(5, 6, 3);
            expected_sudoku.set_value(7, 6, 7);
            expected_sudoku.set_value(0, 7, 5);
            expected_sudoku.set_value(3, 7, 2);
            expected_sudoku.set_value(0, 8, 1);
            expected_sudoku.set_value(2, 8, 4);
            expected_sudoku.set_value(0, 0, 4);
