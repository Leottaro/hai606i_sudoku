...
mod tests {
    ...
    fn test_parse_file() {
        ...
        if let Err(((x1, y1), (x2, y2))) = parsed_sudoku.is_valid() {
            ...
            expected_sudoku.fix_value(0, 0, 6);
            expected_sudoku.fix_value(2, 0, 2);
            expected_sudoku.fix_value(4, 0, 5);
            expected_sudoku.fix_value(5, 1, 4);
            expected_sudoku.fix_value(7, 1, 3);
            expected_sudoku.fix_value(0, 3, 4);
            expected_sudoku.fix_value(1, 3, 3);
            expected_sudoku.fix_value(5, 3, 8);
            expected_sudoku.fix_value(1, 4, 1);
            expected_sudoku.fix_value(6, 4, 2);
            expected_sudoku.fix_value(6, 5, 7);
            expected_sudoku.fix_value(0, 6, 5);
            expected_sudoku.fix_value(3, 6, 2);
            expected_sudoku.fix_value(4, 6, 7);
            expected_sudoku.fix_value(7, 7, 8);
            expected_sudoku.fix_value(8, 7, 1);
            expected_sudoku.fix_value(3, 8, 6);
